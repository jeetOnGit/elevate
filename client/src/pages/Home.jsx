...
const Home = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="relative bg-[#ff9700] text-white overflow-hidden bg-[url('/images/heroBg.png')] bg-no-repeat bg-cover bg-center h-screen flex justify-center items-center">
        

        <div className="container mx-auto px-6 md:py-32 relative z-10 max-[420px]:py-15 max-[420px]:px-3">
